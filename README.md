...
## Description
This mod for Dungeon Siege 1 adds a slider below the field commands to change the game speed beyond the limits of the release version of the game.
...
- Make sure you have ikkyo.dll or ikkyo_loa.dll in your installation directory.
